...
function addCSPHeaders() {
    ...
    if (!document.querySelector('meta[http-equiv="Content-Security-Policy"]')) {
        ...
        cspMeta.content = "default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'self'; form-action 'self'; script-src 'self' https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://www.gstatic.com https://www.googletagmanager.com 'unsafe-inline'; style-src 'self' https://cdnjs.cloudflare.com https://fonts.googleapis.com 'unsafe-inline'; font-src 'self' https://cdnjs.cloudflare.com https://fonts.gstatic.com data:; img-src 'self' data: https:; connect-src 'self' https://api.emailjs.com https://*.googleapis.com https://*.firebaseio.com https://*.firebaseio-demo.com https://*.gstatic.com https://*.firebaseapp.com https://*.cloudfunctions.net https://firebasestorage.googleapis.com https://securetoken.googleapis.com https://identitytoolkit.googleapis.com https://firebaseinstallations.googleapis.com https://firestore.googleapis.com https://storage.googleapis.com https://fcmregistrations.googleapis.com https://fcm.googleapis.com https://www.google-analytics.com https://www.googletagmanager.com https://*.backblazeb2.com https://*.onrender.com wss://*.firebaseio.com wss://firestore.googleapis.com; frame-src 'self' data: blob: https:; child-src 'self' data: blob: https:; upgrade-insecure-requests;";
